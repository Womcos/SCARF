...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--DS', action='store_true', default=False,
                            help='Deep supervision according to 1 / 2 decay.')
        parser.add_argument('--CTF', action='store_true', default=False,
                            help='use coarse to fine loss. 1.0 for all')
    ...
    def __init__(self, args):
        ...
        if args.DS:
            model = get_segmentation_model(args.model, dataset=args.dataset,
                                           ...
                                           DS=args.DS, dilated=args.dilated, multi_grid=args.multi_grid)
        else:
            model = get_segmentation_model(args.model, dataset=args.dataset,
                                           backbone=args.backbone, aux=args.aux,
                                           se_loss=args.se_loss, norm_layer=SyncBatchNorm,
        ...
        # criterions
        self.criterion = SegmentationLosses(DS=args.DS,
                                            CTF=args.CTF,
